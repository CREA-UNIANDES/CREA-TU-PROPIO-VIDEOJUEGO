/**
 * Archivo JavaScript personalizable de CREA
...
function crearCorazones() {
    ...
    for (let i = 0; i < VIDAS_INICIALES; i++) { 
        ...
        corazon.src = '../../../Assets/CorazónRojo.png'; 
...
function actualizarVidasVisualmente() {
    ...
    for (let i = 0; i < corazones.length; i++) {
        if (i < vidas) {
            corazones[i].src = '../../../Assets/CorazónRojo.png'; 
        } else {
            corazones[i].src = '../../../Assets/CorazónVacío.png';
        }
