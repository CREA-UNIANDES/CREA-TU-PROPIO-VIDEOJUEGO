/**
 * Archivo JavaScript personalizable de Mario
...
OBJETOS = [
    { 
        tipo: 'moneda',          // Nombre del objeto
        clase: 'objeto-moneda',  // Clase CSS para dar estilo
        puntos: 1,            // Puntos que da al recogerlo
        probabilidad: 0.25    // Probabilidad de que aparezca (entre 0 y 1)
    },
    { 
        tipo: 'florFuego',          // Nombre del objeto
        clase: 'objeto-fuego',  // Clase CSS para dar estilo
        puntos: 2,            // Puntos que da al recogerlo
        probabilidad: 0.20    // Probabilidad de que aparezca (entre 0 y 1)
    },
    { 
        tipo: 'florHielo',          // Nombre del objeto
        clase: 'objeto-hielo',  // Clase CSS para dar estilo
        puntos: 5,            // Puntos que da al recogerlo
        probabilidad: 0.15    // Probabilidad de que aparezca (entre 0 y 1)
    },
    { 
        tipo: 'estrella',          // Nombre del objeto
        clase: 'objeto-estrella',  // Clase CSS para dar estilo
        puntos: 10,            // Puntos que da al recogerlo
        probabilidad: 0.10    // Probabilidad de que aparezca (entre 0 y 1)
    },
    { 
        tipo: 'rojo',          // Nombre del objeto
        clase: 'objeto-rojo',  // Clase CSS para dar estilo
        puntos: -3,            // Puntos que da al recogerlo
        probabilidad: 0.15    // Probabilidad de que aparezca (entre 0 y 1)
    },
    { 
        tipo: 'verde',          // Nombre del objeto
        clase: 'objeto-verde',  // Clase CSS para dar estilo
        puntos: -1,            // Puntos que da al recogerlo
        probabilidad: 0.15    // Probabilidad de que aparezca (entre 0 y 1)
    },
    { 
        tipo: 'hongo',          // Nombre del objeto
        clase: 'objeto-hongo',  // Clase CSS para dar estilo
        puntos: 0,            // Puntos que da al recogerlo
        vidaExtra: true,      // Indica que da vida extra
        probabilidad: 0.10    // Probabilidad de que aparezca (entre 0 y 1)
    },
    { 
        tipo: 'bowser',          // Nombre del objeto
        clase: 'objeto-bowser',  // Clase CSS para dar estilo
        puntos: 0,            // Puntos que da al recogerlo
...
function crearCorazones() {
    ...
    for (let i = 0; i < VIDAS_INICIALES; i++) { 
        ...
        corazon.src = '../../../Assets/HongoVerde.png'; 
...
function actualizarVidasVisualmente() {
    ...
    for (let i = 0; i < corazones.length; i++) {
        if (i < vidas) {
            corazones[i].src = '../../../Assets/HongoVerde.png';
        } else {
            corazones[i].src = '../../../Assets/HongoGris.png';
        }
