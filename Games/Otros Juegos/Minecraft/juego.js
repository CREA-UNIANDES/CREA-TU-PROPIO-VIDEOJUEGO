/**
 * Archivo JavaScript personalizable de Minecraft
...
OBJETOS = [
    { 
        tipo: 'piedra',          // Nombre del objeto
        clase: 'objeto-piedra',  // Clase CSS para dar estilo
        puntos: 1,            // Puntos que da al recogerlo
        probabilidad: 0.25    // Probabilidad de que aparezca (entre 0 y 1)
    },
    { 
        tipo: 'hierro',          // Nombre del objeto
        clase: 'objeto-hierro',  // Clase CSS para dar estilo
        puntos: 2,            // Puntos que da al recogerlo
        probabilidad: 0.20    // Probabilidad de que aparezca (entre 0 y 1)
    },
    { 
        tipo: 'oro',          // Nombre del objeto
        clase: 'objeto-oro',  // Clase CSS para dar estilo
        puntos: 5,            // Puntos que da al recogerlo
        probabilidad: 0.15    // Probabilidad de que aparezca (entre 0 y 1)
    },
    { 
        tipo: 'diamante',          // Nombre del objeto
        clase: 'objeto-diamante',  // Clase CSS para dar estilo
        puntos: 10,            // Puntos que da al recogerlo
        probabilidad: 0.10    // Probabilidad de que aparezca (entre 0 y 1)
    },
    { 
        tipo: 'veneno',          // Nombre del objeto
        clase: 'objeto-veneno',  // Clase CSS para dar estilo
        puntos: -3,            // Puntos que da al recogerlo
        probabilidad: 0.15    // Probabilidad de que aparezca (entre 0 y 1)
    },
    { 
        tipo: 'podrida',          // Nombre del objeto
        clase: 'objeto-podrida',  // Clase CSS para dar estilo
        puntos: -1,            // Puntos que da al recogerlo
        probabilidad: 0.15    // Probabilidad de que aparezca (entre 0 y 1)
    },
    { 
        tipo: 'manzana',          // Nombre del objeto
        clase: 'objeto-manzana',  // Clase CSS para dar estilo
        puntos: 0,            // Puntos que da al recogerlo
        vidaExtra: true,      // Indica que da vida extra
        probabilidad: 0.10    // Probabilidad de que aparezca (entre 0 y 1)
    },
    { 
        tipo: 'tnt',          // Nombre del objeto
        clase: 'objeto-tnt',  // Clase CSS para dar estilo
        puntos: 0,            // Puntos que da al recogerlo
...
function crearCorazones() {
    ...
    for (let i = 0; i < VIDAS_INICIALES; i++) { 
        ...
        corazon.src = '../../../Assets/CorazónRojoMinecraft.png'; 
...
function reproducirSonido(tipo) {
    switch(tipo) {
        case 'punto':
            document.getElementById('sonidoPunto').currentTime = 0;
            document.getElementById('sonidoPunto').play();
            break;
        case 'perdida':
            document.getElementById('sonidoPerdida').currentTime = 0;
            document.getElementById('sonidoPerdida').play();
            break;
        case 'gameover':
            document.getElementById('sonidoGameOver').currentTime = 0;
...
function actualizarVidasVisualmente() {
    ...
    for (let i = 0; i < corazones.length; i++) {
        if (i < vidas) {
            corazones[i].src = '../../../Assets/CorazónRojoMinecraft.png'; 
        } else {
            corazones[i].src = '../../../Assets/CorazónGrisMinecraft.png';
        }
