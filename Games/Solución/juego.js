...
VELOCIDAD_PERSONAJE = 20; // Tarea 3: Cambiar la velocidad del personaje (ejemplo 20)

VELOCIDAD_CAIDA = 3; // Tarea 3: Cambiar la velocidad de caída de los objetos (ejemplo 3)

INTERVALO_CREACION = 1000; // Tarea 3: Cambiar la frecuencia de aparición de objetos (ejemplo 1000)
...
function crearCorazones() {
    ...
    for (let i = 0; i < VIDAS_INICIALES; i++) { // Tarea 6: Reemplaza VIDAS por la variable creada
        ...
        corazon.src = '../../Assets/CorazónRojo.png'; // Tarea 6: Agrega la imagen del corazón rojo
